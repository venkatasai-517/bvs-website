          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center justify-center h-full text-white px-4 md:px-12 text-center md:text-left">
              ...
              <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
                ...
                <button className="px-6 py-3 bg-green-600 text-white font-semibold rounded-3xl hover:bg-green-700 transition duration-300 flex items-center justify-center shadow-md">
